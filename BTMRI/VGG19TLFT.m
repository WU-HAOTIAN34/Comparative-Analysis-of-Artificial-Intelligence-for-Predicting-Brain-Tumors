...
trainingDS = imageDatastore('/root/autodl-tmp/dataset/Br35H+SARTAJ+figshare/cropped/Training',...
    'IncludeSubfolders',true,'LabelSource','foldernames');
testDS = imageDatastore('/root/autodl-tmp/dataset/Br35H+SARTAJ+figshare/cropped/Testing',...
    'IncludeSubfolders',true,'LabelSource','foldernames');
...
miniBatchSize = 36; % lower this if your GPU runs out of memory.
...
maxEpochs = 50 % one complete pass through the training data
...
opts = trainingOptions('sgdm', ...
    ...
    'ValidationPatience',50000,...
    'ValidationFrequency',100,...
    'VerboseFrequency',100,...
    'CheckpointPath', '/root/autodl-tmp/matlab_script',... % path to save trained model 
