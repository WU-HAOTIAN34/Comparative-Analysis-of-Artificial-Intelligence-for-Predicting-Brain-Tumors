...
trainingDS = imageDatastore('/root/autodl-tmp/dataset/figshare_MBTD/augmented/Training',...
    'IncludeSubfolders',true,'LabelSource','foldernames');
testDS = imageDatastore('/root/autodl-tmp/dataset/figshare_MBTD/augmented/Testing',...
    'IncludeSubfolders',true,'LabelSource','foldernames');
